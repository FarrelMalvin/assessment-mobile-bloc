...
class HalamanPengurangan extends StatefulWidget {
  const HalamanPengurangan({super.key});

  @override
  State<HalamanPengurangan> createState() => _HalamanPenguranganState();
}

class _HalamanPenguranganState extends State<HalamanPengurangan> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Bloc_calculator, State_calculator>(
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text("Halaman Pengurangan"),
          ),
          body: Center(
            child: Padding(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Input angka untuk pengurangan",
                    ),
                  ),
                  SizedBox(height: 20),
                  ElevatedButton(
                      ...
                      if (inputText.isNotEmpty) {
                        try {
                          ...
                          context.read<Bloc_calculator>().add(
                            Event_calculator_pengurangan(input)
                          );
