...
class HalamanPenjumlahan extends StatefulWidget {
  const HalamanPenjumlahan({super.key});

  @override
  State<HalamanPenjumlahan> createState() => _HalamanPenjumlahanState();
}

class _HalamanPenjumlahanState extends State<HalamanPenjumlahan> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Bloc_calculator, State_calculator>(
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text("Halaman Penjumlahan"),
          ),
          body: Center(
            child: Padding(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Input angka untuk penjumlahan",
                    ),
                  ),
                  SizedBox(height: 20),
                  ElevatedButton(
                      ...
                      if (inputText.isNotEmpty) {
                        try {
                          ...
                          context.read<Bloc_calculator>().add(
                            Event_calculator_penjumlahan(input)
                          );
